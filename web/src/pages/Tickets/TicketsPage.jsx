...
const statusLabels = {
  pending: 'قيد الانتظار', assigned: 'معين', in_progress: 'قيد التنفيذ',
...
export default function TicketsPage() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => { queryClient.invalidateQueries({ queryKey: ['tickets'] }); toast.success('تم إنشاء البلاغ بنجاح') },
    ...
    <div>
      ...
      <div className="flex gap-4 mb-6">
        <div className="relative flex-1 max-w-md">
          ...
          <input type="text" placeholder="بحث..." value={filter}
        ...
        <table className="w-full min-w-[700px]">
          ...
          <tbody className="divide-y">
            {isLoading ? (
              ...
              <tr><td colSpan={5} className="text-center py-8 text-gray-500">لا توجد بلاغات</td></tr>
            ) : (
