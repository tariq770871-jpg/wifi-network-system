...
const navItems = [
  ...
  { path: '/tickets', label: 'البلاغات', icon: Ticket },
  { path: '/tracking', label: 'التتبع الحي', icon: MapPin },
  { path: '/map-points', label: 'نقاط الخريطة', icon: Map },
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <aside className={`${sidebarOpen ? 'w-64' : 'w-16'} bg-white shadow-lg transition-all duration-300 flex flex-col`}>
        ...
        <div className="p-4 border-t">
          ...
          <button
            onClick={logout}
            className="flex items-center gap-2 text-red-600 hover:text-red-700 w-full px-3 py-2 rounded-lg hover:bg-red-50"
          >
            <LogOut size={18} />
